				...
				<ul className='acordingList'>	
					{
						data.map((elem,index) => (
						<li 
						className={'walk' + (index===visibleItem ? " active" :"")}
						key={index}
						onClick={() =>onClick(index) }
						
						>
							<div class="accordion_item">
								<span className='accordion_item_title'>Network Design & Implementation</span>
								<span className='accordion_item_num'>0{index+1}</span>
							</div>
							<div class="accordion_menu">
								<div className={'acordionBlockInformation'}>
									<span className="accordionBlockInformationIndex">0{index+1}</span>
									<div className="accordionBlockInformationTime">
										...
										<div className='accordionBlockInformationTimeName'>
											<p className='accordionBlockInformationTimeNameTitle'>{elem.title}</p>
											<p className='accordionBlockInformationTimeNameDate'>{elem.date}</p>
										</div>
										<button type='submit' className='accordionBlockInformationTimeBtn'>
											More Information
										</button>
										</div>	
								</div>
