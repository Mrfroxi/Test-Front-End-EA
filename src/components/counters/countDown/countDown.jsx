...
import ElemCounterTimer from '../../../entities/elemCounterTimer/elemCounterTimer';
...
const CountDown =  () => {
    ...
    const startTimer= ( ) => {
            ...
            const notUtcHours = Math.floor(distance%(1000*60*60*24) / ( 1000 * 60 *60))
            const notUtcMinutes = Math.floor(distance%(1000*60*60) / (1000*60))
